// lucide-react no longer ships brand/logo icons, so GitHub and LinkedIn are
// hand-rolled as simple, minimal SVG marks that share lucide's sizing API
// (className + currentColor) for drop-in use anywhere in the app.
